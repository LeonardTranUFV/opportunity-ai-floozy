@echo off
REM ---------------------------------------------------------------
REM  VDN Logistics - local dev server
REM
REM  Copy this file into the VDN Logistics project folder (next to its
...
REM ---------------------------------------------------------------
REM  VDN Logistics owns port 3100. Pinned, not left to chance.
REM
REM    3000  Pearl River hotel system
REM    3001  Opportunity AI
REM    3100  VDN Logistics   <- this one
REM
...
title VDN Logistics - dev server (port %PORT%)
...
if not exist "package.json" (
  ...
  echo       Copy this file into the VDN Logistics folder and run it there.
  echo.
  pause
  exit /b 1
)
